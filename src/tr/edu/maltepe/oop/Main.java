...
public class Main {
    ...
    public static void main(String[] args) {
        Prof prof1 = new Prof(3421, "gorkem", "cirtma");
        Prof prof2 = new Prof(4531, "gorkem", "cirtma");
        Prof prof3 = new Prof(2345, "gorkem", "cirtma");
        Student student1 = new Student(4687, "gizem", "aydın");
        Student student2 = new Student(2346, "gizem", "aydın");
        Student student3 = new Student(4573, "gizem", "aydın");
